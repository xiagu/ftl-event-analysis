...
declare namespace math {
  ...
  interface MathJsStatic extends FactoryDependencies {
     ...
     */
    typed:
        (name: string, signatures: Record<string, (...args: any[]) => any>) =>
            ((...args: any[]) => any);
     ...
     */
    bignumber(x?:|number|string|Fraction|BigNumber|MathArray|Matrix|boolean|
              Fraction|null): BigNumber;
     ...
     */
    boolean(x: string|number|boolean|MathArray|Matrix|null): boolean|MathArray
        |Matrix;
     ...
     */
    createUnit(
        name: string, definition?: string|UnitDefinition,
        options?: CreateUnitOptions): Unit;
    /**
     * Create a user-defined unit and register it with the Unit type.
    ...
    fraction(
        ...
        denominator?: number|string|MathArray|Matrix): Fraction|MathArray
        |Matrix;
     ...
     */
    matrix(
        data: MathArray|Matrix, format?: 'sparse'|'dense',
        dataType?: string): Matrix;
     ...
     */
    number(value?:|string|number|BigNumber|Fraction|boolean|MathArray|Matrix|
           Unit|null): number|MathArray|Matrix;
    /**
     * @param value Value to be converted
     ...
     */
    lup(A?: Matrix|
        MathArray): {L: MathArray|Matrix; U: MathArray | Matrix; P: number[]};
     ...
     */
    lusolve(
        A: Matrix|MathArray|number, b: Matrix|MathArray, order?: number,
        threshold?: number): Matrix|MathArray;
     ...
     */
    rationalize(
        expr: MathNode|string, optional?: object|boolean, detailed?: true): {
      expression: MathNode|string,
      variables: string[],
      coefficients: MathType[]
    };
    rationalize(
        expr: MathNode|string, optional?: object|boolean,
        detailed?: false): MathNode;
     ...
     */
    simplify(
        expr: MathNode|string, rules?: Array<({
          l: string;
          r: string
        } | string | ((node: MathNode) => MathNode))>,
        scope?: object): MathNode;
     ...
     */
    log(x: number|BigNumber|Complex|MathArray|Matrix,
        base?: number|BigNumber|Complex): number|BigNumber|Complex|MathArray
        |Matrix;
     ...
     */
    mod(x: number|BigNumber|Fraction|MathArray|Matrix,
        y: number|BigNumber|Fraction|MathArray|Matrix): number|BigNumber
    ...
    norm(
        ...
        p?: number|BigNumber|string): number|BigNumber;
    ...
    nthRoot(
        ...
        root?: number|BigNumber): number|Complex|MathArray|Matrix;
    ...
    round(
        ...
        n?: number|BigNumber|MathArray): number|BigNumber|Fraction|Complex
        |MathArray|Matrix;
    ...
    bitAnd(
        ...
        y: number|BigNumber|MathArray|Matrix): number|BigNumber|MathArray
        |Matrix;
     ...
     */
    leftShift(x: number|BigNumber|MathArray|Matrix, y: number|BigNumber): number
        |BigNumber|MathArray|Matrix;
     ...
     */
    rightArithShift(x: number|BigNumber|MathArray|Matrix, y: number|BigNumber):
     ...
     */
    rightLogShift(x: number|MathArray|Matrix, y: number): number|MathArray
        |Matrix;
     ...
     */
    conj(x: number|BigNumber|Complex|MathArray|Matrix): number|BigNumber|Complex
        |MathArray|Matrix;
     ...
     */
    im(x: number|BigNumber|Complex|MathArray|Matrix): number|BigNumber|MathArray
        |Matrix;
     ...
     */
    re(x: number|BigNumber|Complex|MathArray|Matrix): number|BigNumber|MathArray
        |Matrix;
     ...
     */
    distance(x: MathArray|Matrix|object, y: MathArray|Matrix|object): number
        |BigNumber;
     ...
     */
    intersect(
        w: MathArray|Matrix, x: MathArray|Matrix, y: MathArray|Matrix,
        z: MathArray|Matrix): MathArray;
     ...
     */
    and(x: number|BigNumber|Complex|Unit|MathArray|Matrix,
        y: number|BigNumber|Complex|Unit|MathArray|Matrix): boolean|MathArray
        |Matrix;
     ...
     */
    not(x: number|BigNumber|Complex|Unit|MathArray|Matrix): boolean|MathArray
        |Matrix;
     ...
     * nonzero/nonempty value.
     */
    or(x: number|BigNumber|Complex|Unit|MathArray|Matrix,
       y: number|BigNumber|Complex|Unit|MathArray|Matrix): boolean|MathArray
        |Matrix;
     ...
     * nonzero/nonempty value.
     */
    xor(x: number|BigNumber|Complex|Unit|MathArray|Matrix,
        y: number|BigNumber|Complex|Unit|MathArray|Matrix): boolean|MathArray
        |Matrix;
     ...
     */
    identity(size: number|number[]|Matrix|MathArray, format?: string): Matrix
        |MathArray|number;
    /**
    ...
    filter(
        ...
        test:
            ((value: any, index: any,
              matrix: Matrix|MathArray|string[]) => boolean)|RegExp): Matrix
        |MathArray;
     ...
     */
    map(x: Matrix|MathArray,
        callback:
            ((value: any, index: any, matrix: Matrix|MathArray) => MathType |
                 string)): Matrix|MathArray;
    ...
    range(start: number|BigNumber, end: number|BigNumber, includeEnd?: boolean):
        Matrix;
    range(
        start: number|BigNumber, end: number|BigNumber, step: number|BigNumber,
        includeEnd?: boolean): Matrix;
     ...
     */
    resize(
        x: MathArray|Matrix, size: MathArray|Matrix,
        defaultValue?: number|string): MathArray|Matrix;
     ...
     */
    size(x: boolean|number|Complex|Unit|string|MathArray|Matrix): MathArray
        |Matrix;
    ...
    sort(
        x: Matrix|MathArray,
        compare: ((a: any, b: any) => number)|'asc'|'desc'|'natural'): Matrix
        |MathArray;
     ...
     */
    subset(
        value: MathArray|Matrix|string, index: Index, replacement?: any,
        defaultValue?: any): MathArray|Matrix|string;
     ...
     */
    factorial(n: number|BigNumber|MathArray|Matrix): number|BigNumber|MathArray
        |Matrix;
    ...
    gamma(n: MathArray): MathArray;
    gamma(n: Matrix): Matrix;
    ...
    random(size: MathArray|Matrix, min?: number, max?: number): MathArray
        |Matrix;
    ...
    randomInt(size: MathArray|Matrix, min?: number, max?: number): MathArray
        |Matrix;
     ...
     * x < y, and 0 when x == y.
     */
    compare(x: MathType|string, y: MathType|string): number|BigNumber|Fraction
        |MathArray|Matrix;
     ...
     * x < y, and 0 when x == y.
     */
    compareText(x: string|MathArray|Matrix, y: string|MathArray|Matrix): number
        |MathArray|Matrix;
     ...
     */
    deepEqual(x: MathType, y: MathType): number|BigNumber|Fraction|Complex|Unit
        |MathArray|Matrix;
     ...
     */
    equalText(x: string|MathArray|Matrix, y: string|MathArray|Matrix): number
        |MathArray|Matrix;
     ...
     * element
     */
    setMultiplicity(e: number|BigNumber|Fraction|Complex, a: MathArray|Matrix):
        number;
     ...
     */
    setSymDifference(a1: MathArray|Matrix, a2: MathArray|Matrix): MathArray
        |Matrix;
     ...
     */
    quantileSeq(
        A: MathArray|Matrix, prob: number|BigNumber|MathArray,
        sorted?: boolean): number|BigNumber|Unit|MathArray;
     ...
     */
    format(
        value: any, options?: FormatOptions|number|((item: any) => string),
     ...
     */
    print(
        template: string, values: any, precision?: number,
        options?: number|object): void;
 ...
 * To avoid errors when using one of the imported functions extend module like
 * this:
 *
 * @example
...
import(object: ImportObject|ImportObject[], options: ImportOptions): void;
  ...
  interface FactoryDependencies {
    create:
        (factories: FactoryFunctionMap,
         config: ConfigOptions) => Partial<MathJsStatic>;
    factory: <T>(
        name: string,
  ...
  interface Matrix {
    ...
    clone(): Matrix;
    size(): number[];
    map(callback: (a: any, b: number, c: Matrix) => any,
        skipZeros?: boolean): Matrix;
    forEach(
  ...
  interface MathNode {
     ...
     */
    filter(callback: (node: MathNode, path: string, parent: MathNode) => any):
        MathNode[];

    /**
     * [forEach description]
     */
    forEach(callback: (node: MathNode, path: string, parent: MathNode) => any):
        MathNode[];
  ...
  interface MathJsJson {
    /**
     * Returns reviver function that can be used as reviver in JSON.parse
     * function.
     */
  ...
  interface MathJsChain {
     ...
     * 0.
     */
    createUnit(definition?: string|UnitDefinition, options?: CreateUnitOptions):
        MathJsChain;
    /**
     * Create a user-defined unit and register it with the Unit type.
     * @param options (optional) An object containing any of the following
     ...
     * by default. When false, output will not be simplified.
     */
    derivative(variable: MathNode|string, options?: {simplify: boolean}):
        MathJsChain;
     ...
     * see slu for details. Matrix must be a SparseMatrix.
     */
    lusolve(b: Matrix|MathArray, order?: number, threshold?: number):
        MathJsChain;
     ...
     * the calculation is for line and plane
     */
    intersect(x: MathArray|Matrix, y: MathArray|Matrix, z: MathArray|Matrix):
        MathJsChain;
     ...
     */
    filter(test:
               ((value: any, index: any, matrix: Matrix|MathArray) => Matrix |
                    MathArray)|RegExp): MathJsChain;
     ...
     */
    forEach(callback:
                ((value: any, index: any, matrix: Matrix|MathArray) => void)):
        MathJsChain;
    ...
    partitionSelect(
        k: number,
        compare?: 'asc'|'desc'|((a: any, b: any) => number)): MathJsChain;
    ...
    range(end: number|BigNumber, step: number|BigNumber, includeEnd?: boolean):
        MathJsChain;
     ...
     * b, and 0 when a == b. Default value: ‘asc’
     */
    sort(compare: ((a: any, b: any) => number)|'asc'|'desc'|
         'natural'): MathJsChain;
    ...
    format(
        value: any, options?: FormatOptions|number|((item: any) => string),
        callback?: ((value: any) => string)): MathJsChain;
     ...
     * numbers. See function math.format for a description of all options.
     */
    print(values: any, precision?: number, options?: number|object):
        MathJsChain;
